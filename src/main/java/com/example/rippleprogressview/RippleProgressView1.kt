...
class RippleProgressView1 @JvmOverloads constructor(
    ...
    // 文本相关属性
    private var text: String = "100%" // 默认文本
    private var textColor: Int = Color.WHITE // 文本颜色
    private var textSize: Float = 40f // 文本大小
    ...
    private fun drawText(canvas: Canvas) {
        val paint = Paint().apply {
            color = textColor
            textSize = this@RippleProgressView1.textSize
        }
        ...
        // 将文本绘制在圆球正中间的位置
        canvas.drawText(text, radius - (length / 2), radius + textSize / 2, paint)
    }
